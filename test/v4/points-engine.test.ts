...
import { PointsEngine } from '../../src/v4/engine/PointsEngine';

describe('PointsEngine - Basic Operations', () => {
  let engine: PointsEngine;

  beforeEach(() => {
    engine = new PointsEngine({ matchUpFormat: 'SET3-S:6/TB7' });
  });
...
describe('PointsEngine - Undo/Redo', () => {
  let engine: PointsEngine;
...
describe('PointsEngine - Game Boundaries', () => {
  let engine: PointsEngine;
...
describe('PointsEngine - Set Boundaries', () => {
  let engine: PointsEngine;
...
describe('PointsEngine - State Management', () => {
  let engine: PointsEngine;
  ...
  test('should set state from JSON', () => {
    ...
    const engine2 = new PointsEngine();
...
describe('PointsEngine - Match Completion', () => {
  test('should detect match completion', () => {
    const engine = new PointsEngine({ matchUpFormat: 'SET1-S:TB10' });
