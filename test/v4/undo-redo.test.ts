/**
 * Undo/Redo Tests - v4.0 with PointsEngine
 * 
 * Tests native undo/redo across all scenarios using PointsEngine.
 * All 19 tests now use mutation engine with snapshot-based undo.
 */

import { describe, test, expect } from 'vitest';
import { PointsEngine } from '../../src/v4';
...
describe('Undo/Redo - Short Set Format (S:4/TB7)', () => {
  test('should undo in short set format', () => {
    const engine = new PointsEngine({ matchUpFormat: 'SET3-S:4/TB7' });
...
describe('Undo/Redo - Advantage Set Format', () => {
  test('should undo in advantage final set', () => {
    const engine = new PointsEngine({ matchUpFormat: 'SET5-S:6/TB7-F:6' });
