 ...
 *
 * SOURCE: Copied from tods-competition-factory (CourtHive/factory)
 * This code is maintained in the Factory repository and copied here for UMO integration.
 * 
 * @see https://github.com/CourtHive/tods-competition-factory
 */
import { parseFormat as parse } from '../formatConverter';

// constants - match status values
...
export function validateSetScore(
  ...
  const setFormat = isDecidingSet && (parsed as any).finalSetFormat ? (parsed as any).finalSetFormat : (parsed as any).setFormat;
